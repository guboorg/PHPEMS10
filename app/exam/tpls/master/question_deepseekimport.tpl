			...
			<div id="datacontent">
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form class="form-horizontal ajax" action="index.php?exam-master-questions-deepseekimport" method="post">
						...
						<div class="form-group"><label class="control-label col-sm-2">模型</label><div class="col-sm-4"><input class="form-control" type="text" name="model" value="deepseek-chat" /></div><div class="col-sm-4 help-block">使用 DeepSeek Chat Completions 接口。</div></div>
